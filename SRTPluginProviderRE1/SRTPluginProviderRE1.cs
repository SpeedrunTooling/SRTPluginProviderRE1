...
{
    public class SRTPluginProviderRE1 : IPluginProvider
    {
        private Process process;
        private GameMemoryRE1Scanner gameMemoryScanner;
        ...
        public int Startup(IPluginHostDelegates hostDelegates)
        {
            ...
            process = GetProcess();
            gameMemoryScanner = new GameMemoryRE1Scanner(process);
        ...
        private Process GetProcess() => Process.GetProcessesByName("bhd")?.FirstOrDefault();
    }
}