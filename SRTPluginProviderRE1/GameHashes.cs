...
namespace SRTPluginProviderRE1
{
    ...
    {
        private static readonly byte[] bhdWW_20250205_1 = new byte[32] { 0x1F, 0x4B, 0x8B, 0x17, 0xA3, 0x4E, 0x65, 0xA5, 0x18, 0x50, 0x8E, 0x00, 0x00, 0x2F, 0xDB, 0x02, 0xC5, 0xC7, 0x2F, 0xAD, 0xBB, 0x8B, 0xC7, 0x78, 0x04, 0x5D, 0x66, 0xBB, 0xFB, 0x8C, 0xE2, 0x8A };
        ...
        public static GameVersion DetectVersion(string filePath)
        {
            ...
            if (checksum.SequenceEqual(bhdWW_20250205_1))
                return GameVersion.WW_20250205_1;
            else if (checksum.SequenceEqual(bhdWW_20230801_1))
